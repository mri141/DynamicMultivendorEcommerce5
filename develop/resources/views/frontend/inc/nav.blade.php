     ...
     <div class="container border-gray-200">
            ...
            <!--<div class="collapse navbar-collapse text-right" id="navbarSupportedContent">-->
                ...
                <!--<ul class="list-inline mb-0 mobile-hor-swipe text-right">-->
                    ...
                    <!--</li>-->
                     ...
                     <li class="list-inline-item mr-0">
                        <a href="https://play.google.com/store/apps/details?id=com.sobkisubazar.ecommerce"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
         ...
         @else
          <ul class="list-inline mb-0 mobile-hor-swipe text-right">
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded get-app-btn"> বিনোদন </button>
                        </a>
