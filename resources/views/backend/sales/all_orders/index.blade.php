...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
    ...
    <!--                    <td>
                ...
                <a href="{{ route('invoice.download', $order->id) }}" type="button" class="btn btn-icon btn-light btn-sm"  target="_blank"><i class="las la-print"></i></a>
                
                
                    
                    
                 <!--<a href="{{ route('invoice.download', $order->id) }}" type="button" class="btn btn-icon btn-light btn-sm"  target="_blank" onclick="window.open('#', '_blank');window.open(this.href, '_self');"><i class="las la-print"></i></a>-->
                 <!--<a href="{{ route('invoice.download', $order->id) }}" type="button" class="btn btn-icon btn-light btn-sm" target="popup-example" onClick="javascript:open('', 'popup-example', 'height=400,width=500,resizable=no');"><i class="las la-print"></i></a>-->
