          ...
          <div class="col-lg-4 col-sm-6">
                ...
                <div class="calloremail mt-3 float-lg-end ml-3">
                   <ul class="list-unstyled">
                      ...
                      <li class="mb-2">
                         <p class="f-address"><span class="" style="background: #1c1c1c;color: #fff;border-radius: 50%;padding: 2px 5px;font-family: 'Roboto', sans-serif;"><i class="fa-solid fa-house-chimney"></i></span>  {{ $locale == 'en' ? '65, Rasul View, Suite-8/A, Mymensingh Lane, Banglamotor, Dhaka-1000.' : ' ৬৫, রসূল ভিউ, স্যুট- ৮/এ, ময়মনসিংহ লেন, বাংলামটর, ঢাকা-১০০০' }} </p>
                      </li>
                   </ul>
            </div>
          </div>
       ...
       <div class="my-4">
                ...
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/ourservices">
                  ...
                  <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/buyerPartner">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;"> {{ $locale == 'en' ? 'Buyer Partner' : 'ক্রেতা পার্টনার' }} </h4>
                </a>
                </li>
                
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/supplierPartner">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;"> {{ $locale == 'en' ? 'Supplier Partner' : ' সরবরাহকারী পার্টনার' }} </h4>
                </a>
                </li>
                ...
                <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;"> {{ $locale == 'en' ? 'Sobkisu Bazar Blog' : ' সবকিছু বাজার ব্লগ' }} </h4>
                  ...
                  <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/faq">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;"> {{ $locale == 'en' ? 'FAQ' : ' জিজ্ঞাসিত প্রশ্নাবলী (FAQ)' }} </h4>
                </a>
                </li>
               </div>
       ...
       <div class="my-4">
                ...
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/helpcenter">
                 ...
                 <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/privacypolicy">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'Privacy Policy' : 'গোপনীয়তা নীতিমালা' }} </h4>
                </a>
                </li>
                
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/terms">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'Terms & Conditions' : 'শর্তাবলী' }} </h4>
                </a>
                </li>
                
                  <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/ad-policy">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'Advertising Policy' : 'বিজ্ঞাপন পলিসি' }}</h4>
                </a>
                </li>
                
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/sellerpolicy">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'Seller Policy' : 'বিক্রেতা পলিসি'}}</h4>
                </a>
                </li>
                
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/customerpolicy">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'Customer Policy' : 'ক্রেতা পলিসি' }}</h4>
                </a>
                </li>
                ...
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/returnpolicy">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'Return Refund Policy' : 'রিটার্ন-রিপ্লেসমেন্ট পলিসি' }}</h4>
                </a>
                </li>
       ...
       <div class="my-4">
                 <h5 class="footer-text-title font-weight-bold"> {{ $locale == 'en' ? 'Trade Services' : 'ট্রেড সার্ভিসেস' }} </h5>
                  ...
                  <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/tradeassurance">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;"> {{ $locale == 'en' ? 'Trade Assurance' : 'ট্রেড অ্যাসুরেন্স'}}  </h4>
                </a>
                </li>
                
                 <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/businessIdentity">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'Business Identity' : 'ব্যবসায়িক পরিচিতি'}}</h4>
                </a>
                </li>
                ...
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/allManufacturer">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">{{ $locale == 'en' ? 'All Manufacturer' : 'সকল প্রস্তুতকারক'}} </h4>
                </a>
                </li>
               </div>
   ...
   <div class="container" >
      <div class="row no-gutters">
         <div class="col-lg-3 col-sm-3">
            ...
            <div class="col-lg-3 col-sm-3">
                <div class="my-4">
                    <p class="download-text download-text-sm" style=""><span class="f-icon mr-3"><i class="fa-solid fa-download fa-2x text-white"></i></span>{{ $locale == 'en' ? 'Download Apps' : 'মোবাইল এপ ডাউনলোড'}}</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-3">
    ...
    <div class="container">
        <div class="row">
             <div class="col-lg-9 mx-auto">
                 <h4 class="h4 text-left text-font text-white text-center footer-text-info">{{ $locale == 'en' ? 'Copyright © 2022 • Sobkisu Bazar • Developed by ' : 'কপিরাইট@ ২০২২.    সবকিছু  বাজার.    ডেভেলপড বাই' }}<a href="#">Enrich IT Solution</a> </h4>
             </div>
        </div>
    </div>
