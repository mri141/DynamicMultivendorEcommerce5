            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <!--<img class="d-block w-100 bannar1 mb-2" src="{{asset('public/upload/offer_banner/up-to-50.jpg')}}" alt="First slide">-->
                         <div class="row">
                                ...
                                <div class="carousel-box">
                                    <a href="{{ $value->button_link ? $value->button_link : '#'  }}">
                                        <img
                                            ...
                                            src="{{asset('public/upload/offer_banner/up-to-50.jpg')}}"
                                            alt="{{ $value->title }}"
