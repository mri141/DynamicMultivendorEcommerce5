...
<a href="javascript:void(0)" class="d-flex align-items-center text-reset h-100" data-toggle="dropdown" data-display="static">
    ...
    <span class="flex-grow-1 ml-1 mb-3">
        @if(isset($cart) && count($cart) > 0)
            <span class="badge badge-inline badge-pill cart-count" style="color: #fff !important;background-color:#ff6a00 !important">
                {{ count($cart)}}
            </span>
        @else
            <span class="badge badge-primary badge-inline badge-pill cart-count" style="color: #fff !important;background-color:#ff6a00 !important">0</span>
        @endif
